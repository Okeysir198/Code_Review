...
def get_details_verification_prompt(client_data: Dict[str, Any], agent_name: str, state: Dict[str, Any] = None) -> str:
...
def create_details_verification_agent(
    ...
    def dynamic_prompt(state: CallCenterAgentState) -> SystemMessage:
        prompt_content = get_details_verification_prompt(client_data, agent_name, state.to_dict() if hasattr(state, 'to_dict') else state)
